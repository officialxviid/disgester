...
const createOverflowUpdateSegment = (t, n) => {
  ...
  const {B: f, Y: _, A: h, L: g} = getEnvironment();
  ...
  const [H, M] = v ? v.M(w, _, r, i, o, getViewportOverflowState, hideNativeScrollbars) : [ () => w, () => [ noop ] ];
  return (t, n, i) => {
    const {wt: u, zt: f, bt: v, $t: w, vt: P, St: D} = t;
    const {gt: B, yt: V} = o();
  ...
  return on(l, "pointerdown", (o => {
    ...
    if (continuePointerDown(o, t, e)) {
      ...
      if (t) {
        ...
        if (t) {
          push(m, t.T(c, getHandleOffset, b, v, p));
        }
      }
      on(l, "pointerup", (t => {
        runEachAndClear(m);
...
const createScrollbarsSetupElements = (t, n, o) => {
  ...
  const {slot: c} = e;
  const {rt: r, Z: i, J: l, K: a, ut: u, st: d, lt: f, dt: h} = n;
  ...
  const appendElements = () => {
    appendChildren(w, b[0].Ut);
    appendChildren(w, m[0].Ut);
    _((() => {
  ...
  return [ {
    ...
    Kt: {
      Qt: b,
      tn: y,
      nn: scrollbarsHandleStyle.bind(0, b)
    },
    sn: {
      Qt: m,
      tn: S,
...
const OverlayScrollbars = (t, n, o) => {
  ...
  if (n && !u) {
    ...
    const $ = {
      ...
      state() {
        const {Tt: t, Et: n, Ot: o, It: s, tt: e, xt: c, yt: r} = v();
        return assignDeep({}, {
          overflowEdge: t,
          overflowAmount: n,
          overflowStyle: o,
    ...
    if (cancelInitialization(v.Ft.lt, e().cancel, !l && t.cancel)) {
      destroy(true);
      return $;
    }
    v.qt();
    ...
    h("initialized", [ $ ]);
    v.Nt(((t, n, o) => {
      const {wt: s, St: e, vt: c, Lt: r, Ht: i, At: l, bt: a, zt: u} = t;
      h("updated", [ $, {
        updateHints: {
          sizeChanged: s,
          directionChanged: e,
...
exports.ScrollbarsHidingPlugin = Ct;

exports.SizeObserverPlugin = mt;
